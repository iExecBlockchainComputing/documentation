...
Application developers needs to publish their application sell order to the v7 marketplace in order to makes it available for requesters.
...
Dataset developers needs to push their dataset secret to the v7 SMS and publish their dataset sell order to the v7 marketplace in order to makes it available for requesters.
