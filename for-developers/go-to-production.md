...
All secrets are pushed to an SMS where they are securely saved, protected by an enclave, which means even we, the root-privilege user, cannot access them. Only authorized applications can access them.
