...
In the following table, the task type column behaves as follow:

- `STD` designates failures only triggered by _standard tasks_.
- `TEE` designates failures only triggered by _TEE tasks_.
- Failures without an explicit type can appear for _standard_ and _TEE_ tasks.

{% endhint %}


| Replicate failure cause | Replicate status | Task type | Description |
| --- | --- | --- | --- |
...
| `DATASET_FILE_DOWNLOAD_FAILED` | `DATA_DOWNLOADING` | `STD` | Dataset download failed |
| `DATASET_FILE_BAD_CHECKSUM` | `DATA_DOWNLOADING` | `STD` | Downloaded dataset checksum does not match on-chain provided checksum |
| `INPUT_FILES_DOWNLOAD_FAILED` | `DATA_DOWNLOADING` | `STD` | At least one input file could not be downloaded |
| `APP_NOT_FOUND_LOCALLY` | `COMPUTING` | | The `application OCI` image could not be found on the worker |
| `TEE_PREPARATION_FAILED` | `COMPUTING` | `TEE` | TEE task preparation step could not be completed, task cannot be executed by the worker |
| `TEE_SESSION_GENERATION_INVALID_AUTHORIZATION` | `COMPUTING` | `TEE` | |
| `TEE_SESSION_GENERATION_EXECUTION_NOT_AUTHORIZED_EMPTY_PARAMS_UNAUTHORIZED` | `COMPUTING` | `TEE` | |
| `TEE_SESSION_GENERATION_EXECUTION_NOT_AUTHORIZED_NO_MATCH_ONCHAIN_TYPE` | `COMPUTING` | `TEE` | |
| `TEE_SESSION_GENERATION_EXECUTION_NOT_AUTHORIZED_GET_CHAIN_TASK_FAILED` | `COMPUTING` | `TEE` | |
| `TEE_SESSION_GENERATION_EXECUTION_NOT_AUTHORIZED_TASK_NOT_ACTIVE` | `COMPUTING` | `TEE` | |
| `TEE_SESSION_GENERATION_EXECUTION_NOT_AUTHORIZED_GET_CHAIN_DEAL_FAILED` | `COMPUTING` | `TEE` | |
| `TEE_SESSION_GENERATION_EXECUTION_NOT_AUTHORIZED_INVALID_SIGNATURE` | `COMPUTING` | `TEE` | |
| `TEE_SESSION_GENERATION_PRE_COMPUTE_GET_DATASET_SECRET_FAILED` | `COMPUTING` | `TEE` | |
| `TEE_SESSION_GENERATION_APP_COMPUTE_NO_ENCLAVE_CONFIG` | `COMPUTING` | `TEE` | |
| `TEE_SESSION_GENERATION_APP_COMPUTE_INVALID_ENCLAVE_CONFIG` | `COMPUTING` | `TEE` | |
| `TEE_SESSION_GENERATION_POST_COMPUTE_GET_ENCRYPTION_TOKENS_FAILED_EMPTY_BENEFICIARY_KEY` | `COMPUTING` | `TEE` | |
| `TEE_SESSION_GENERATION_POST_COMPUTE_GET_STORAGE_TOKENS_FAILED` | `COMPUTING` | `TEE` | |
| `TEE_SESSION_GENERATION_POST_COMPUTE_GET_SIGNATURE_TOKENS_FAILED_EMPTY_WORKER_ADDRESS` | `COMPUTING` | `TEE` | |
| `TEE_SESSION_GENERATION_POST_COMPUTE_GET_SIGNATURE_TOKENS_FAILED_EMPTY_PUBLIC_ENCLAVE_CHALLENGE` | `COMPUTING` | `TEE` | |
| `TEE_SESSION_GENERATION_POST_COMPUTE_GET_SIGNATURE_TOKENS_FAILED_EMPTY_TEE_CHALLENGE` | `COMPUTING` | `TEE` | |
| `TEE_SESSION_GENERATION_POST_COMPUTE_GET_SIGNATURE_TOKENS_FAILED_EMPTY_TEE_CREDENTIALS` | `COMPUTING` | `TEE` | |
| `TEE_SESSION_GENERATION_SECURE_SESSION_STORAGE_CALL_FAILED` | `COMPUTING` | `TEE` | |
| `TEE_SESSION_GENERATION_SECURE_SESSION_GENERATION_FAILED` | `COMPUTING` | `TEE` | |
| `TEE_SESSION_GENERATION_SECURE_SESSION_NO_TEE_PROVIDER` | `COMPUTING` | `TEE` | |
| `TEE_SESSION_GENERATION_SECURE_SESSION_UNKNOWN_TEE_PROVIDER` | `COMPUTING` | `TEE` | |
| `TEE_SESSION_GENERATION_GET_TASK_DESCRIPTION_FAILED` | `COMPUTING` | `TEE` | |
| `TEE_SESSION_GENERATION_NO_SESSION_REQUEST` | `COMPUTING` | `TEE` | |
| `TEE_SESSION_GENERATION_NO_TASK_DESCRIPTION` | `COMPUTING` | `TEE` | |
| `TEE_SESSION_GENERATION_GET_SESSION_FAILED` | `COMPUTING` | `TEE` | |
| `TEE_SESSION_GENERATION_UNKNOWN_ISSUE` | `COMPUTING` | `TEE` | |
| `PRE_COMPUTE_INVALID_ENCLAVE_CONFIGURATION` | `COMPUTING` | `TEE` | Application enclave configuration is invalid |
| `PRE_COMPUTE_INVALID_ENCLAVE_HEAP_CONFIGURATION` | `COMPUTING` | `TEE` | Application requested HEAP size is bigger than maximum allocatable memory |
| `PRE_COMPUTE_IMAGE_MISSING` | `COMPUTING` | `TEE` | The `pre-compute OCI` image could not be found on the worker |
| `PRE_COMPUTE_TASK_ID_MISSING` | `COMPUTING` | `TEE` | The `IEXEC_TASK_ID` environment variable could not be resolved from the `pre-compute` container |
| `PRE_COMPUTE_EXIT_REPORTING_FAILED` | `COMPUTING` | `TEE` | The `pre-compute` container failed to post its failure cause to the worker |
| `PRE_COMPUTE_OUTPUT_PATH_MISSING` | `COMPUTING` | `TEE` | The `IEXEC_PRE_COMPUTE_OUT` environment variable could not be resolved from the `pre-compute` container |
| `PRE_COMPUTE_IS_DATASET_REQUIRED_MISSING` | `COMPUTING` | `TEE` | The `IS_DATASET_REQUIRED` environment variable could not be resolved from the `pre-compute` container |
| `PRE_COMPUTE_DATASET_URL_MISSING` | `COMPUTING` | `TEE` | The `IEXEC_DATASET_URL` environment variable could not be resolved from the `pre-compute` container |
| `PRE_COMPUTE_DATASET_KEY_MISSING` | `COMPUTING` | `TEE` | The `IEXEC_DATASET_KEY` environment variable could not be resolved from the `pre-compute` container |
| `PRE_COMPUTE_DATASET_CHECKSUM_MISSING` | `COMPUTING` | `TEE` | The `IEXEC_DATASET_CHECKSUM` environment variable could not be resolved from the `pre-compute` container |
| `PRE_COMPUTE_DATASET_FILENAME_MISSING` | `COMPUTING` | `TEE` | The `IEXEC_DATASET_FILENAME` environment variable could not be resolved from the `pre-compute` container |
| `PRE_COMPUTE_INPUT_FILES_NUMBER_MISSING` | `COMPUTING` | `TEE` | The `IEXEC_INPUT_FILES_NUMBER` environment variable could not be resolved from the `pre-compute` container |
| `PRE_COMPUTE_AT_LEAST_ONE_INPUT_FILE_URL_MISSING` | `COMPUTING` | `TEE` | At least one environment variable starting with `IEXEC_INPUT_FILE_URL_` prefix could not be resolve from the `pre-compute` container |
| `PRE_COMPUTE_OUTPUT_FOLDER_NOT_FOUND` | `COMPUTING` | `TEE` | |
| `PRE_COMPUTE_DATASET_DOWNLOAD_FAILED` | `COMPUTING` | `TEE` | |
| `PRE_COMPUTE_INVALID_DATASET_CHECKSUM` | `COMPUTING` | `TEE` | |
| `PRE_COMPUTE_DATASET_DECRYPTION_FAILED` | `COMPUTING` | `TEE` | |
| `PRE_COMPUTE_SAVING_PLAIN_DATASET_FAILED` | `COMPUTING` | `TEE` | |
| `PRE_COMPUTE_INPUT_FILE_DOWNLOAD_FAILED` | `COMPUTING` | `TEE` | |
| `PRE_COMPUTE_TIMEOUT` | `COMPUTING` | `TEE` | |
| `PRE_COMPUTE_FAILED_UNKNOWN_ISSUE` | `COMPUTING` | `TEE` | |
| `APP_COMPUTE_FAILED` | `COMPUTING` | | The application execution failed |
| `POST_COMPUTE_IMAGE_MISSING` | `COMPUTING` | `TEE` | The `post-compute OCI` image could not be found on the worker |
| `POST_COMPUTE_TASK_ID_MISSING` | `COMPUTING` | `TEE` | The `RESULT_TASK_ID` environment variable could not be resolved from the `post-compute` container |
| `POST_COMPUTE_EXIT_REPORTING_FAILED` | `COMPUTING` | `TEE` | The `post-compute` container failed to post its failure cause to the worker |
| `POST_COMPUTE_WORKER_ADDRESS_MISSING` | `COMPUTING` | `TEE` | The `RESULT_SIGN_WORKER_ADDRESS` environment variable could not be resolved from the `post-compute` container |
| `POST_COMPUTE_TEE_CHALLENGE_PRIVATE_KEY_MISSING` | `COMPUTING` | `TEE` | The `RESULT_SIGN_TEE_CHALLENGE_PRIVATE_KEY` environment variable could not be resolved from the `post-compute` container |
| `POST_COMPUTE_ENCRYPTION_PUBLIC_KEY_MISSING` | `COMPUTING` | `TEE` | The `RESULT_ENCRYPTION_PUBLIC_KEY` environment variable could not be resolved from the `post-compute` container |
| `POST_COMPUTE_STORAGE_TOKEN_MISSING` | `COMPUTING` | `TEE` | The `RESULT_STORAGE_TOKEN` environment variable could not be resolved from the `post-compute` container |
...
| `POST_COMPUTE_ENCRYPTION_FAILED` | `COMPUTING` | `TEE` | Results encryption failed in `post-compute` container |
| `POST_COMPUTE_RESULT_FILE_NOT_FOUND` | `COMPUTING` | `TEE` | Local result file to upload could not be found |
| `POST_COMPUTE_DROPBOX_UPLOAD_FAILED` | `COMPUTING` | `TEE` | Upload to `DROPBOX` failed |
| `POST_COMPUTE_IPFS_UPLOAD_FAILED` | `COMPUTING` | `TEE` | Upload to `IPFS` failed |
| `POST_COMPUTE_INVALID_TEE_SIGNATURE` | `COMPUTING` | `TEE` | The provided signed TEE challenge is invalid |
