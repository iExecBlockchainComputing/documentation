...
* **APP\_DOWNLOADING**: Your worker is downloading the application
...
* **CANT\_CONTRIBUTE\_SINCE\_STAKE\_TOO\_LOW**: Your worker hasn't enough RLC in its account to contribute \(30% of the task in RLC by default\)
