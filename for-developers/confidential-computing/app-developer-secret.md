...
docker run -it --rm \
            ...
            registry.scontain.com:5050/scone-production/iexec-sconify-image:5.3.15-v10 \
            sconify_iexec \
            --name=${IMG_NAME} \
            --from=${IMG_FROM} \
            --to=${IMG_TO} \
...
```sh
iexec app run <appAddress> --tag tee --workerpool v7-debug.main.pools.iexec.eth --watch --chain bellecour
```
