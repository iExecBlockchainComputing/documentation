...
[Inputs and Outputs guide](/documentation/build-iapp/guides/inputs-and-outputs) to learn how
...
- **Build an iApp**: Check out the
  [iApp Generator guide](/documentation/build-iapp/iapp-generator) to create your first data
  processor
...
- **See it in action**: Try our [Hello World tutorial](/documentation/helloWorld) for
  a complete example
