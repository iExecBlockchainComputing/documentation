...
The [Content Creator demo](/documentation/use-cases) shows
...
- **See it in action**: Try the
  [Content Creator demo](/documentation/use-cases) to understand
  the full flow
- **Start simple**: Begin with
  [pay-per-use via grantAccess](/documentation/manage-data/guides/manage-access)
- **Explore sharing**: Try
  [DataProtector Sharing](/documentation/manage-data/dataProtector/dataProtectorSharing) for
